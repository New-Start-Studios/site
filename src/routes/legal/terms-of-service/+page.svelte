...
<article class="prose lg:prose-lg">
	...
	<h2>2. Use License</h2>
	<p>
		Permission is granted to temporarily download one copy of the materials on {config.branding.name}'s Website
	...
	<h2>3. Disclaimer</h2>
	<p>
		All the materials on {config.branding.name}’s Website are provided "as is". {config.branding.name} makes no
		warranties, may it be expressed or implied, therefore negates all other warranties. Furthermore,
		{config.branding.name} does not make any representations concerning the accuracy or reliability of the use
		of the materials on its Website or otherwise relating to such materials or any sites linked to
		this Website.
	</p>
	<h2>4. Limitations</h2>
	<p>
		{config.branding.name} or its suppliers will not be hold accountable for any damages that will arise with
		the use or inability to use the materials on {config.branding.name}’s Website, even if {config.branding.name} or an
	...
	<p>
		The materials appearing on {config.branding.name}’s Website may include technical, typographical, or
		photographic errors. {config.branding.name} will not promise that any of the materials in this Website are
		accurate, complete, or current. {config.branding.name} may change the materials contained on its Website at
		any time without notice. {config.branding.name} does not make any commitment to update the materials.
	</p>
	<h2>6. Links</h2>
	<p>
		{config.branding.name} has not reviewed all of the sites linked to its Website and is not responsible for
	...
	<p>
		{config.branding.name} may revise these Terms of Use for its Website at any time without prior notice. By
	...
	<p>
		Any claim related to {config.branding.name}'s Website shall be governed by the laws of us without regards
		to its conflict of law provisions. We are based in the United States, however, if the
		circumstances require foreign laws to be applicable, please let us know when you contact us.
	</p>
</article>
