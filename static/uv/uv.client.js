					...
					if (
						...
						void 0 === (s = t._events)
							...
							: (void 0 !== s.newListener &&
									(t.emit('newListener', e, r.listener ? r.listener : r), (s = t._events)),
							  (n = s[e])),
						void 0 === n)
					)
		...
		const c = class extends t {
			...
			overrideSend() {
				this.ctx.override(this.xhrProto, 'send', (t, r, [i = null]) => {
					...
					return (
						this.emit('send', o), o.intercepted ? o.returnValue : o.target.call(o.that, o.data.body)
					);
				});
			}
			...
			overrideGetResHeaders() {
				this.ctx.override(this.xhrProto, 'getAllResponseHeaders', (t, r) => {
					const i = new e({ value: t.call(r) }, t, r);
					return (
						this.emit('getAllResponseHeaders', i), i.intercepted ? i.returnValue : i.data.value
					);
				});
			}
		...
		const u = class extends t {
			...
			overrideGo() {
				this.ctx.override(this.historyProto, 'go', (t, r, [i]) => {
					...
					return (
						this.emit('go', o), o.intercepted ? o.returnValue : o.target.call(o.that, o.data.delta)
					);
				});
			}
			overrideForward() {
			...
			emulate(t, e) {
				...
				return (
							...
							get() {
								...
								return (
									i.window.DOMStringList &&
										i.ctx.nativeMethods.setPrototypeOf(t, i.window.DOMStringList.prototype),
									t
								);
							},
							set: void 0,
					...
					this.ctx.window.Location &&
						this.ctx.nativeMethods.setPrototypeOf(r, this.ctx.window.Location.prototype),
					r
				);
			}
		};
			...
			emulate(t, r = {}) {
				...
				const i = new this.ctx.window.Proxy(r, {
					...
					set: (r, i, o) => {
						...
						return (
							this.emit('set', s), s.intercepted ? s.returnValue : (t[s.data.name] = s.data.value)
						);
					},
					deleteProperty: (r, i) => {
				...
				return (
					this.wrappers.set(i, t), this.ctx.nativeMethods.setPrototypeOf(i, this.storeProto), i
				);
			}
		};
